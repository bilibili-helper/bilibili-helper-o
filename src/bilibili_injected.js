/* global filenameSanitize: false, MessageBox: false, SelectModule: false,
   generateASS: false, setPosition: false, parseXML: false, ABP: false */
(function() {
    ...
    let initHelper = function() {
        ...
        chrome.runtime.sendMessage({
            ...
            if (!$('.b-page-body').length) {
                ...
                biliHelper.redirectUrl = decodeURIComponent(window.__GetCookie('redirectUrl'));
          ...
          // biliHelper.mainBlock.switcherSection.find('a.b-btn[type="' + newMode + '"]').removeClass('w');
                ...
                original: function() {
                    ...
                    notifyCidHack(function() {
                        ...
                        if ($('#bofqi embed').attr('width') === 950) {
                            $('#bofqi embed').attr('width', 980);
                        }
                    });
                },
                swf: function() {
    ...
    if (biliHelper.site === 0) {
        ...
        $('.scontent object param[name="flashvars"]').length) {
