    ...
    addListener = () => {
        const requestFilter = {
            urls: [
                ...
                '*://api.bilibili.com/pgc/player/web/playurl*', // 新番剧页面
        ...
        chrome.webRequest.onBeforeSendHeaders.addListener(details => {
            ...
            const fromHelper = !_.isEmpty(_.find(requestHeaders, ({name, value}) => name === 'From' && value === 'bilibili-helper1.2.31')) || details.url.toLocaleLowerCase().match('from=bilibili-helper');
