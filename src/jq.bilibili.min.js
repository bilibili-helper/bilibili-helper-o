...
function __SetCookie(e, t) {
    var n = 365;
    var r = new Date;
    r.setTime(r.getTime() + n * 24 * 60 * 60 * 1000);
...
function agFB(e, t, n, r) {
    $.ajax('/feedback/agreement?aid=' + t + '&news_id=' + n + '&rid=' + r, {
        success: function (t) {
            if (t != 'OK') {
                (new MessageBox).show(e, t, 2000, 'warning')
            } else {
        ...
        error: function () {
            (new MessageBox).show(e, '发送失败，请检查您的网络或发送邮件至 orz#hdslb.com', 2000, 'error')
        }
    });
    return false
}
...
function attentionUser(e, t) {
    ...
    $.ajax('/m/attention?uid=' + t, {
        success: function (r) {
            ...
            n.show(e, r == 'OK' ? '关注成功!' : r, r == 'OK' ? 500 : 2000, r == 'OK' ? 'ok' : 'warning')
        },
        error: function () {
            n.show(e, '系统错误，请稍后重试!', 2000, 'error')
        }
    })
}
function unattentionUser(e, t) {
    ...
    $.ajax('/m/unattention?uid=' + t, {
        success: function (r) {
            ...
            n.show(e, r == 'OK' ? '取消关注成功!' : r, r == 'OK' ? 500 : 2000, r == 'OK' ? 'ok' : 'warning')
        },
        error: function () {
            n.show(e, '系统错误，请稍后重试!', 2000, 'error')
        }
...
function goTop(e, t) {
    ...
    function r(e) {
        if (!vn[e]) {
            ...
            n.remove();
            if (r === 'none' || r === '') {
                mn || (mn = _.createElement('iframe'), mn.frameBorder = mn.width = mn.height = 0),
                    t.appendChild(mn);
                if (!gn || !mn.createElement) gn = (mn.contentWindow || mn.contentDocument).document,
                    gn.write((H.support.boxModel ? '<!doctype html>' : '') + '<html><body>'),
                    gn.close();
                n = gn.createElement(e),
    ...
    function f(e, n) {
        ...
        for (s = 1; s < u; s++) {
            ...
            if (f === '*') f = l;
                ...
                !h && !d && H.error('No conversion from ' + c.replace(' ', ' to ')),
                    h !== !0 && (n = h ? h(n) : d(p(n)))
            }
        }
        return n
    ...
    function v(e, t, n) {
        var r = t === 'width' ? e.offsetWidth : e.offsetHeight,
            ...
            s = 4;
        if (r > 0) {
            if (n !== 'border') for (; i < s; i += 2) n || (r -= parseFloat(H.css(e, 'padding' + jt[i])) || 0),
                n === 'margin' ? r += parseFloat(H.css(e, n + jt[i])) || 0 : r -= parseFloat(H.css(e, 'border' + jt[i] + 'Width')) || 0;
            return r + 'px'
        }
        r = Ft(e, t);
        ...
        r = parseFloat(r) || 0;
        if (n) for (; i < s; i += 2) r += parseFloat(H.css(e, 'padding' + jt[i])) || 0,
            n !== 'padding' && (r += parseFloat(H.css(e, 'border' + jt[i] + 'Width')) || 0),
            n === 'margin' && (r += parseFloat(H.css(e, n + jt[i])) || 0);
        return r + 'px'
    }
    function m(e) {
    ...
    var _ = e.document,
        ...
        H = function () {
            ...
            r.fn = r.prototype = {
                    ...
                    ready: function (e) {
                        if (e === !0 && !--r.readyWait || e !== !0 && !r.isReady) {
                            ...
                            N.fireWith(_, [
                                ...
                                r.fn.trigger && r(_).trigger('ready').off('ready')
                        }
                    },
                    bindReady: function () {
                        if (!N) {
                            ...
                            if (_.addEventListener) _.addEventListener('DOMContentLoaded', C, !1),
                                e.addEventListener('load', r.ready, !1);
                            else if (_.attachEvent) {
                                _.attachEvent('onreadystatechange', C),
                ...
                o = r(_),
                _.addEventListener ? C = function () {
                    _.removeEventListener('DOMContentLoaded', C, !1),
                        r.ready()
                }
        ...
        var n = [
            ...
            l = function (t) {
                ...
                for (r = 0, i = t.length; r < i; r++) s = t[r],
                    o = H.type(s),
                    o === 'array' ? l(s) : o === 'function' && (!e.unique || !h.has(s)) && n.push(s)
            },
            c = function (t, l) {
                l = l || [
                ],
                ...
                o = !1,
                    n && (e.once ? i === !0 ? h.disable() : n = [
                    ] : r && r.length && (i = r.shift(), h.fireWith(i[0], i[1])))
            },
            h = {
                add: function () {
                    if (n) {
                        var e = n.length;
                        l(arguments),
                            o ? a = n.length : i && i !== !0 && (u = e, c(i[0], i[1]))
                    }
                    return this
                },
                remove: function () {
    ...
    H.extend({
                            ...
                            H.each({
                                ...
                                H.isFunction(n) ? u[e](function () {
                                    s = n.apply(this, arguments),
                                        s && H.isFunction(s.promise) ? s.promise().then(r.resolve, r.reject, r.notify) : r[i + 'With'](this === u ? r : this, [
                                            s
                                        ])
                                }) : u[e](r[i])
                            })
        ...
        when: function (e) {
            function t(e) {
                return function (t) {
                    o[e] = arguments.length > 1 ? j.call(arguments, 0) : t,
                        f.notifyWith(l, o)
                }
            }
            function n(e) {
        ...
        H.support = function () {
            ...
            i = _.createElement('select'),
                s = i.appendChild(_.createElement('option')),
                ...
                H.boxModel = t.boxModel = _.compatMode === 'CSS1Compat',
                o.checked = !0,
            ...
            if (p.attachEvent) for (c in {
                ...
                h = l in p,
                h || (p.setAttribute(l, 'return;'), h = typeof p[l] == 'function'),
                t[c + 'Bubbles'] = h;
            u.removeChild(p),
                u = i = s = p = o = null,
                H(function () {
                    var n,
                        ...
                        m,
                        g,
                        y = _.getElementsByTagName('body')[0];
        ...
        removeData: function (e, t, n) {
            if (!!H.acceptData(e)) {
                ...
                if (t) {
                    r = n ? a[f] : a[f].data;
                    if (r) {
                        H.isArray(t) || (t in r ? t = [
                            t
                        ] : (t = H.camelCase(t), t in r ? t = [
                            t
                        ] : t = t.split(' ')));
                ...
                H.support.deleteExpando || !a.setInterval ? delete a[f] : a[f] = null,
                    u && (H.support.deleteExpando ? delete e[o] : e.removeAttribute ? e.removeAttribute(o) : e[o] = null)
            }
        },
                    ...
                    if (this.length) {
                        ...
                        if (a.nodeType === 1 && !H._data(a, 'parsedAttrs')) {
                            ...
                            for (u = s.length; f < u; f++) o = s[f].name,
                                o.indexOf('data-') === 0 && (o = H.camelCase(o.substring(5)), O(a, o, l[o]));
        ...
        H.extend({
            ...
            dequeue: function (e, t) {
                ...
                r === 'inprogress' && (r = n.shift()),
                    r && (t === 'fx' && n.unshift('inprogress'), H._data(e, t + '.run', i), r.call(e, function () {
                        H.dequeue(e, t)
                    }, i)),
                    n.length || (H.removeData(e, t + 'queue ' + t + '.run', !0), L(e, t, 'queue'))
            }
        }),
        H.fn.extend({
            queue: function (e, n) {
            ...
            promise: function (e, n) {
                ...
                var i = H.Deferred(),
                    ...
                    l = e + 'mark',
                    c;
                while (o--) if (c = H.data(s[o], a, t, !0) || (H.data(s[o], f, t, !0) || H.data(s[o], l, t, !0)) && H.data(s[o], a, H.Callbacks('once memory'), !0)) u++ ,
                    c.add(r);
                r();
                return i.promise(n)
            }
    ...
    H.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return this.each(function () {
                ...
                } else if (n === 'undefined' || n === 'boolean') this.className && H._data(this, '__className__', this.className),
                    ...
                    return this.each(function (r) {
                        ...
                        if (this.nodeType === 1) {
                            i ? o = e.call(this, r, s.val()) : o = e,
                                o == null ? o = '' : typeof o == 'number' ? o += '' : H.isArray(o) && (o = H.map(o, function (e) {
                                    return e == null ? '' : e + ''
                                })),
        ...
        H.extend({
            ...
            attr: function (e, n, r, i) {
                ...
                if (!!e && a !== 3 && a !== 8 && a !== 2) {
                    ...
                    u = a !== 1 || !H.isXMLDoc(e),
                        u && (n = n.toLowerCase(), o = H.attrHooks[n] || (V.test(n) ? K : J));
                    if (r !== t) {
                        if (r === null) {
                            H.removeAttr(e, n);
                            return
            ...
            removeAttr: function (e, t) {
                var n,
                    ...
                    u = 0;
                if (t && e.nodeType === 1) {
                    r = t.toLowerCase().split(R),
                        s = r.length;
                    for (; u < s; u++) i = r[u],
                        i && (n = H.propFix[i] || i, o = V.test(i), o || H.attr(e, i, ''), e.removeAttribute($ ? i : n), o && n in e && (e[n] = !1))
                }
            },
            attrHooks: {
                type: {
            ...
            prop: function (e, n, r) {
                ...
                if (!!e && u !== 3 && u !== 8 && u !== 2) {
                    o = u !== 1 || !H.isXMLDoc(e),
                        o && (n = H.propFix[n] || n, s = H.propHooks[n]);
        ...
        }, H.attrHooks.tabindex.set = J.set, H.each(['width',
            'height'], function (e, t) {
        ...
        H.support.hrefNormalized || H.each(['href',
            'src',
            'width',
            'height'], function (e, n) {
        ...
        H.support.checkOn || H.each(['radio',
            'checkbox'], function () {
                H.valHooks[this] = {
                    get: function (e) {
    ...
    H.event = {
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (!!s && !!(p = s.events)) {
                ...
                H.isEmptyObject(p) && (v = s.handle, v && (v.elem = null), H.removeData(e, [
                    'events',
                    'handle'
                ], !0))
            }
        ...
        trigger: function (n, r, i, s) {
            if (!i || i.nodeType !== 3 && i.nodeType !== 8) {
                ...
                n = typeof n == 'object' ? n[H.expando] ? n : new H.Event(o, n) : new H.Event(o),
                    n.type = o,
                    n.isTrigger = !0,
                    n.exclusive = f,
                    n.namespace = u.join('.'),
                ...
                for (l = 0; l < m.length && !n.isPropagationStopped(); l++) c = m[l][0],
                    n.type = m[l][1],
                    v = (H._data(c, 'events') || {
                    })[n.type] && H._data(c, 'handle'),
                    v && v.apply(c, r),
                    v = p && c[p],
                    v && H.acceptData(c) && v.apply(c, r) === !1 && n.preventDefault();
                n.type = o,
                    !s && !n.isDefaultPrevented() && (!d._default || d._default.apply(i.ownerDocument, r) === !1) && (o !== 'click' || !H.nodeName(i, 'a')) && H.acceptData(i) && p && i[o] && (o !== 'focus' && o !== 'blur' || n.target.offsetWidth !== 0) && !H.isWindow(i) && (h = i[p], h && (i[p] = null), H.event.triggered = o, i[o](), H.event.triggered = t, h && (i[p] = h));
                return n.result
            }
        },
        dispatch: function (n) {
            n = H.event.fix(n || e.event);
            var r = (H._data(this, 'events') || {
            })[n.type] || [
                ],
                i = r.delegateCount,
                s = [
            ...
            if (!u.preDispatch || u.preDispatch.call(this, n) !== !1) {
                if (i && (!n.button || n.type !== 'click')) {
                    ...
                    for (c = n.target; c != this; c = c.parentNode || this) if (c.disabled !== !0) {
                        ...
                        for (f = 0; f < i; f++) g = r[f],
                            y = g.selector,
                            d[y] === t && (d[y] = g.quick ? st(c, g.quick) : h.is(y)),
                            d[y] && m.push(g);
                        m.length && a.push({
                            elem: c,
                            matches: m
                ...
                for (f = 0; f < a.length && !n.isPropagationStopped(); f++) {
                    ...
                    for (l = 0; l < v.matches.length && !n.isImmediatePropagationStopped(); l++) {
                        g = v.matches[l];
                        if (o || !n.namespace && !g.namespace || n.namespace_re && n.namespace_re.test(g.namespace)) n.data = g.data,
                            n.handleObj = g,
                            p = ((H.event.special[g.origType] || {
                            }).handle || g.handler).apply(v.elem, s),
        ...
        mouseHooks: {
            ...
            filter: function (e, n) {
                var r,
                    ...
                    o = n.button,
                    u = n.fromElement;
                e.pageX == null && n.clientX != null && (r = e.target.ownerDocument || _, i = r.documentElement, s = r.body, e.pageX = n.clientX + (i && i.scrollLeft || s && s.scrollLeft || 0) - (i && i.clientLeft || s && s.clientLeft || 0), e.pageY = n.clientY + (i && i.scrollTop || s && s.scrollTop || 0) - (i && i.clientTop || s && s.clientTop || 0)),
        ...
        fix: function (e) {
            ...
            for (n = o.length; n;) r = o[--n],
                e[r] = i[r];
            e.target || (e.target = i.srcElement || _),
        ...
        H.Event = function (e, t) {
            ...
            e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || e.returnValue === !1 || e.isDefaultPrevented && e.isDefaultPrevented() ? C : k) : this.type = e,
                t && H.extend(this, t),
            ...
            H.event.special[e] = {
                ...
                handle: function (e) {
                    var n = this,
                        ...
                        s = i.selector,
                        o;
                    if (!r || r !== n && !H.contains(n, r)) e.type = i.origType,
                ...
                if (E.length > 1 && v.exec(e)) if (E.length === 2 && d.relative[E[0]]) a = S(E[0] + E[1], t, i);
                    ...
                    if (t) {
                        c = i ? {
                            ...
                            : h.find(E.pop(), E.length === 1 && (E[0] === '~' || E[0] === '+') && t.parentNode ? t.parentNode : t, w),
                ...
                d = h.selectors = {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function (e, t, n, i, s) {
                            if (e[1] === 'not') if ((r.exec(e[3]) || '').length > 1 || /^\w/.test(e[3])) e[3] = h(e[3], null, null, t);
                            else {
            ...
            _.documentElement.compareDocumentPosition ? w = function (e, t) {
                ...
                function () {
                    ...
                    e.innerHTML = '<a name=\'' + n + '\'/>',
                        ...
                        _.getElementById(n) && (d.find.ID = function (e, n, r) {
    ...
    H.fn.extend({
        ...
        add: function (e, t) {
            var n = typeof e == 'string' ? H(e, t) : H.makeArray(e && e.nodeType ? [
                e
            ] : e),
        ...
        H.each({
            ...
            H.fn[e] = function (n, r) {
                ...
                ut.test(e) || (r = n),
                    ...
                    (this.length > 1 || ft.test(r)) && at.test(e) && (i = i.reverse());
        ...
        H.extend({
            filter: function (e, t, n) {
                n && (e = ':not(' + e + ')');
                return t.length === 1 ? H.find.matchesSelector(t[0], e) ? [
                    t[0]
                ] : [
                    ] : H.find.matches(e, t)
            },
            dir: function (e, n, r) {
                var i = [
                    ...
                    s = e[n];
                while (s && s.nodeType !== 9 && (r === t || s.nodeType !== 1 || !H(s).is(r))) s.nodeType === 1 && i.push(s),
                    s = s[n];
                return i
            },
    ...
    kt.optgroup = kt.option,
        ...
        kt.th = kt.td,
        H.support.htmlSerialize || (kt._default = [
            1,
            'div<div>',
            '</div>'
        ]),
        H.fn.extend({
            ...
            remove: function (e, t) {
                for (var n = 0, r; (r = this[n]) != null; n++) if (!e || H.filter(e, [
                    r
                ]).length) !t && r.nodeType === 1 && (H.cleanData(r.getElementsByTagName('*')), H.cleanData([r])),
            ...
            html: function (e) {
                return H.access(this, function (e) {
                    ...
                    if (typeof e == 'string' && !Et.test(e) && (H.support.leadingWhitespace || !mt.test(e)) && !kt[(yt.exec(e) || [
                        '',
                        ''
                    ])[1].toLowerCase()]) {
                        e = e.replace(gt, '<$1></$2>');
                        try {
                            for (; r < i; r++) n = this[r] || {
                                ...
                                n.nodeType === 1 && (H.cleanData(n.getElementsByTagName('*')), n.innerHTML = e);
                            n = 0
                        } catch (s) {
                        }
                    }
            ...
            domManip: function (e, n, r) {
                ...
                if (this[0]) {
                    u = a && a.parentNode,
                        H.support.parentNode && u && u.nodeType === 11 && u.childNodes.length === this.length ? i = {
                            fragment: u
                        }
                            : i = H.buildFragment(e, this, f),
                        o = i.fragment,
                    ...
                    f.length && H.each(f, function (e, t) {
                        t.src ? H.ajax({
                            ...
                            async: !1,
                            dataType: 'script'
                        }) : H.globalEval((t.text || t.textContent || t.innerHTML || '').replace(Ct, '/*$0*/')),
        ...
        H.buildFragment = function (e, t, n) {
            ...
            t && t[0] && (o = t[0].ownerDocument || t[0]),
                o.createDocumentFragment || (o = _),
                e.length === 1 && typeof u == 'string' && u.length < 512 && o === _ && u.charAt(0) === '<' && !St.test(u) && (H.support.checkClone || !Tt.test(u)) && (H.support.html5Clone || !xt.test(u)) && (i = !0, s = H.fragments[u], s && s !== 1 && (r = s)),
                r || (r = o.createDocumentFragment(), H.clean(e, o, r, n)),
                i && (H.fragments[u] = s ? r : 1);
            return {
                fragment: r,
                cacheable: i
            }
        ...
        H.extend({
            clone: function (e, t, n) {
                var r,
                    i,
                    s,
                    o = H.support.html5Clone || H.isXMLDoc(e) || !xt.test('<' + e.nodeName + '>') ? e.cloneNode(!0) : m(e);
            ...
            clean: function (e, t, n, r) {
                ...
                t = t || _,
                    typeof t.createElement == 'undefined' && (t = t.ownerDocument || t[0] && t[0].ownerDocument || _);
                for (var a = 0, f; (f = e[a]) != null; a++) {
                    ...
                    if (typeof f == 'string') if (!wt.test(f)) f = t.createTextNode(f);
                        ...
                        var l = (yt.exec(f) || [
                            ...
                            d = Lt.childNodes,
                            v;
                        t === _ ? Lt.appendChild(p) : x(t).appendChild(p),
                            p.innerHTML = c[1] + f + c[2];
                        ...
                        !H.support.leadingWhitespace && mt.test(f) && p.insertBefore(t.createTextNode(mt.exec(f)[0]), p.firstChild),
                            f = p.childNodes,
                            p && (p.parentNode.removeChild(p), d.length > 0 && (v = d[d.length - 1], v && v.parentNode && v.parentNode.removeChild(v)))
                    }
                    var b;
            ...
            cleanData: function (e) {
                ...
                for (var o = 0, u; (u = e[o]) != null; o++) {
                    ...
                    if (n) {
                        ...
                        s ? delete u[H.expando] : u.removeAttribute && u.removeAttribute(H.expando),
                            delete r[n]
                    }
                }
            }
    ...
    H.fn.css = function (e, n) {
        ...
        H.extend({
            ...
            style: function (e, n, r, i) {
                if (!!e && e.nodeType !== 3 && e.nodeType !== 8 && !!e.style) {
                    ...
                    o = typeof r,
                        o === 'string' && (s = Pt.exec(r)) && (r = + (s[1] + 1) * + s[2] + parseFloat(H.css(e, n)), o = 'number');
        ...
        H.curCSS = H.css,
        _.defaultView && _.defaultView.getComputedStyle && (It = function (e, t) {
            var n,
                r,
                i,
                s,
                o = e.style;
            t = t.replace(Mt, '-$1').toLowerCase(),
                ...
                !H.support.pixelMargin && i && Ht.test(t) && Dt.test(n) && (s = o.width, o.width = n, n = i.width, o.width = s);
            return n
        }),
        _.documentElement.currentStyle && (qt = function (e, t) {
            var n,
                ...
                o = e.style;
            s == null && o && (i = o[t]) && (s = i),
                Dt.test(s) && (n = o.left, r = e.runtimeStyle && e.runtimeStyle.left, r && (e.runtimeStyle.left = e.currentStyle.left), o.left = t === 'fontSize' ? '1em' : s, s = o.pixelLeft + 'px', o.left = n, r && (e.runtimeStyle.left = r));
            return s === '' ? 'auto' : s
        }),
        Ft = It || qt,
        H.each(['height',
    ...
    try {
        ...
        on = _.createElement('a'),
            on.href = '',
            on = on.href
    }
    un = tn.exec(on.toLowerCase()) || [
    ],
        H.fn.extend({
            load: function (e, n, r) {
                    ...
                    complete: function (e, t, n) {
                        n = e.responseText,
                            e.isResolved() && (e.done(function (e) {
                                n = e
                            }), u.html(s ? H('<div>').append(n.replace(Gt, '')).find(s) : n)),
                            r && u.each(r, [
                                n,
                                t,
                                e
        ...
        H.extend({
            ...
            ajaxSetup: function (e, t) {
                t ? h(e, H.ajaxSettings) : (t = e, e = H.ajaxSettings),
                    h(e, t);
                return e
            },
            ajaxSettings: {
            ...
            ajax: function (e, n) {
                ...
                u.promise(T),
                    ...
                    i.url = ((e || i.url) + '').replace(Wt, '').replace(Kt, un[1] + '//'),
                    i.dataTypes = H.trim(i.dataType || '*').toLowerCase().split(Zt),
                    i.crossDomain == null && (w = tn.exec(i.url.toLowerCase()), i.crossDomain = !(!w || w[1] == un[1] && w[2] == un[2] && (w[3] || (w[1] === 'http:' ? 80 : 443)) == (un[3] || (un[1] === 'http:' ? 80 : 443)))),
                    i.data && i.processData && typeof i.data != 'string' && (i.data = H.param(i.data, i.traditional)),
                    p(rn, i, n, T);
                if (E === 2) return !1;
                S = i.global,
                    i.type = i.type.toUpperCase(),
                    i.hasContent = !Jt.test(i.type),
                    S && H.active++ === 0 && H.event.trigger('ajaxStart');
                if (!i.hasContent) {
                    i.data && (i.url += (Qt.test(i.url) ? '&' : '?') + i.data, delete i.data),
                        h = i.url;
                    if (i.cache === !1) {
                        var N = H.now(),
                    ...
                    i.ifModified && (h = h || i.url, H.lastModified[h] && T.setRequestHeader('If-Modified-Since', H.lastModified[h]), H.etag[h] && T.setRequestHeader('If-None-Match', H.etag[h])),
                    T.setRequestHeader('Accept', i.dataTypes[0] && i.accepts[i.dataTypes[0]] ? i.accepts[i.dataTypes[0]] + (i.dataTypes[0] !== '*' ? ', ' + an + '; q=0.01' : '') : i.accepts['*']);
    ...
    H.ajaxSetup({
        ...
        H.ajaxPrefilter('json jsonp', function (t, n, r) {
            ...
            if (t.dataTypes[0] === 'jsonp' || t.jsonp !== !1 && (cn.test(t.url) || i && cn.test(t.data))) {
                var s,
                    o = t.jsonpCallback = H.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
                    u = e[o],
                    a = t.url,
                    f = t.data,
                    l = '$1' + o + '$2';
                t.jsonp !== !1 && (a = a.replace(cn, l), t.url === a && (i && (f = f.replace(cn, l)), t.data === f && (a += (/\?/.test(a) ? '&' : '?') + t.jsonp + '=' + o))),
                    t.url = a,
                    t.data = f,
                    e[o] = function (e) {
                        s = [
        ...
        H.ajaxTransport('script', function (e) {
            if (e.crossDomain) {
                var n,
                    r = _.head || _.getElementsByTagName('head')[0] || _.documentElement;
                return {
                    send: function (i, s) {
                ...
                return {
                    send: function (i, s) {
                        ...
                        o.send(n.hasContent && n.data || null),
                            r = function (e, i) {
                                ...
                                try {
                                    if (r && (i || o.readyState === 4)) {
                                        r = t,
                                            u && (o.onreadystatechange = H.noop, hn && delete dn[u]);
                            ...
                            !n.async || o.readyState === 4 ? r() : (u = ++pn, hn && (dn || (dn = {
                            }, H(e).unload(hn)), dn[u] = r), o.onreadystatechange = r)
                    },
                    abort: function () {
                        r && r(0, 1)
                    }
    ...
    H.fn.extend({
        show: function (e, t, n) {
            ...
            for (var u = 0, a = this.length; u < a; u++) s = this[u],
                s.style && (o = s.style.display, !H._data(s, 'olddisplay') && o === 'none' && (o = s.style.display = ''), (o === '' && H.css(s, 'display') === 'none' || !H.contains(s.ownerDocument.documentElement, s)) && H._data(s, 'olddisplay', r(s.nodeName)));
            for (u = 0; u < a; u++) {
                s = this[u];
                if (s.style) {
                    o = s.style.display;
        ...
        hide: function (e, t, n) {
            ...
            var r,
                ...
                u = this.length;
            for (; o < u; o++) r = this[o],
                r.style && (s = H.css(r, 'display'), s !== 'none' && !H._data(r, 'olddisplay') && H._data(r, 'olddisplay', s));
        ...
        animate: function (e, t, n, i) {
            function s() {
                ...
                for (s in e) {
                    u = e[s],
                        H.isArray(u) ? (t.animatedProperties[s] = u[1], u = e[s] = u[0]) : t.animatedProperties[s] = t.specialEasing && t.specialEasing[s] || t.easing || 'swing';
                    if (u === 'hide' && i || u === 'show' && !i) return t.complete.call(this);
                    n && (s === 'height' || s === 'width') && (t.overflow = [
                        this.style.overflow,
                        this.style.overflowX,
                        this.style.overflowY
                    ], H.css(this, 'display') === 'inline' && H.css(this, 'float') === 'none' && (!H.support.inlineBlockNeedsLayout || r(this.nodeName) === 'inline' ? this.style.display = 'inline-block' : this.style.zoom = 1))
                }
                t.overflow != null && (this.style.overflow = 'hidden');
                for (a in e) f = new H.fx(this, t, a),
                    u = e[a],
                    yn.test(u) ? (m = H._data(this, 'toggle' + a) || (u === 'toggle' ? i ? 'show' : 'hide' : 0), m ? (H._data(this, 'toggle' + a, m === 'show' ? 'hide' : 'show'), f[m]()) : f[u]()) : (h = bn.exec(u), p = f.cur(), h ? (d = parseFloat(h[2]), v = h[3] || (H.cssNumber[a] ? '' : 'px'), v !== 'px' && (H.style(this, a, (d || 1) + v), p = (d || 1) / f.cur() * p, H.style(this, a, p + v)), h[1] && (d = (h[1] === '-=' ? - 1 : 1) * d + p), f.custom(p, d, v)) : f.custom(p, u, ''));
                return !0
            }
            var o = H.speed(t, n, i);
            if (H.isEmptyObject(e)) return this.each(o.complete, [
                !1
            ]);
            e = H.extend({
            }, e);
        ...
        H.fx.prototype = {
            ...
            step: function (e) {
                ...
                if (e || i >= a.duration + this.startTime) {
                    ...
                    if (s) {
                        a.overflow != null && !H.support.shrinkWrapBlocks && H.each(['',
                            'X',
                            'Y'], function (e, t) {
                                u.style['overflow' + t] = a.overflow[e]
                            }),
                            a.hide && H(u).hide();
                        if (a.hide || a.show) for (t in a.animatedProperties) H.style(u, t, a.orig[t]),
                            H.removeData(u, 'fxshow' + t, !0),
                            H.removeData(u, 'toggle' + t, !0);
                        r = a.complete,
                            r && (a.complete = !1, r.call(u))
                    }
                    return !1
                }
                a.duration == Infinity ? this.now = i : (n = i - this.startTime, this.state = n / a.duration, this.pos = H.easing[a.animatedProperties[this.prop]](this.state, n, 0, 1, a.duration), this.now = this.start + (this.end - this.start) * this.pos),
                    this.update();
                return !0
            }
        },
    ...
    'getBoundingClientRect' in _.documentElement ? xn = function (e, t, r, i) {
        ...
        : xn = function (e, t, n) {
            ...
            while ((e = e.parentNode) && e !== o && e !== n) {
                ...
                r = u ? u.getComputedStyle(e, null) : e.currentStyle,
                    f -= e.scrollTop,
                    l -= e.scrollLeft,
                    e === i && (f += e.offsetTop, l += e.offsetLeft, H.support.doesNotAddBorder && (!H.support.doesAddBorderForTableAndCells || !Tn.test(e.nodeName)) && (f += parseFloat(r.borderTopWidth) || 0, l += parseFloat(r.borderLeftWidth) || 0), s = i, i = e.offsetParent),
                    H.support.subtractsBorderForOverflowNotVisible && r.overflow !== 'visible' && (f += parseFloat(r.borderTopWidth) || 0, l += parseFloat(r.borderLeftWidth) || 0),
                    a = r
            }
            if (a.position === 'relative' || a.position === 'static') f += o.offsetTop,
                l += o.offsetLeft;
        ...
        H.offset = {
            ...
            setOffset: function (e, t, n) {
                ...
                var i = H(e),
                    ...
                    o = H.css(e, 'top'),
                    u = H.css(e, 'left'),
                    a = (r === 'absolute' || r === 'fixed') && H.inArray('auto', [
                        o,
                        u
                    ]) > - 1,
                    f = {
    ...
    if (e.cleanData) {
        ...
        e.fn.remove = function (t, n) {
            return this.each(function () {
                if (!n) if (!t || e.filter(t, [
                    this
                ]).length) e('*', this).add([this]).each(function () {
                    try {
    ...
    e.widget.bridge = function (n, r) {
        e.fn[n] = function (i) {
            var s = typeof i === 'string',
                ...
                u = this;
            i = !s && o.length ? e.extend.apply(null, [
                true,
                i
            ].concat(o)) : i;
            ...
            s ? this.each(function () {
                ...
                var t = e.data(this, n);
                t ? t.option(i || {
                })._init() : e.data(this, n, new r(i, this))
            });
            return u
        }
    };
    ...
    e.widget('ui.mouse', {
        ...
        _mouseDown: function (n) {
            if (!t) {
                ...
                var r = this,
                    i = n.which == 1,
                    s = typeof this.options.cancel == 'string' && n.target.nodeName ? e(n.target).closest(this.options.cancel).length : false;
    ...
    e.fn.position = function (i) {
        ...
        e.each(['my',
            'at'], function () {
                var e = (i[this] || '').split(' ');
                if (e.length === 1) e = t.test(e[0]) ? e.concat(['center']) : n.test(e[0]) ? [
                    'center'
                ].concat(e) : [
                        'center',
                        'center'
        ...
        if (i.at[0] === 'right') p.left += l;
        else if (i.at[0] === 'center') p.left += l / 2;
        if (i.at[1] === 'bottom') p.top += h;
        else if (i.at[1] === 'center') p.top += h / 2;
        p.left += f[0];
        p.top += f[1];
        return this.each(function () {
            var t = e(this),
                ...
                o = parseInt(e.curCSS(this, 'marginTop', true)) || 0,
                u = n + s + (parseInt(e.curCSS(this, 'marginRight', true)) || 0),
                d = r + o + (parseInt(e.curCSS(this, 'marginBottom', true)) || 0),
                v = e.extend({
                }, p),
                m;
            if (i.my[0] === 'right') v.left -= n;
            else if (i.my[0] === 'center') v.left -= n / 2;
            if (i.my[1] === 'bottom') v.top -= r;
            else if (i.my[1] === 'center') v.top -= r / 2;
    ...
    if (!e.offset.setOffset) {
        e.offset.setOffset = function (t, n) {
            ...
            var r = e(t),
                i = r.offset(),
                s = parseInt(e.curCSS(t, 'top', true), 10) || 0,
                o = parseInt(e.curCSS(t, 'left', true), 10) || 0;
            i = {
                top: n.top - i.top + s,
    ...
    e.widget('ui.draggable', e.ui.mouse, {
        ...
        _createHelper: function (t) {
            var n = this.options;
            t = e.isFunction(n.helper) ? e(n.helper.apply(this.element[0], [
                t
            ])) : n.helper == 'clone' ? this.element.clone().removeAttr('id') : this.element;
        ...
        _setContainment: function () {
            ...
            if (t.containment == 'document' || t.containment == 'window') this.containment = [
            ...
            if (!/^(document|window|parent)$/.test(t.containment) && t.containment.constructor != Array) {
                ...
                if (n) {
                    ...
                    this.containment = [
                        ...
                        (r ? Math.max(n.scrollWidth, n.offsetWidth) : n.offsetWidth) - (parseInt(e(n).css('borderLeftWidth'), 10) || 0) - (parseInt(e(n).css('paddingRight'), 10) || 0) - this.helperProportions.width - this.margins.left - this.margins.right,
                        (r ? Math.max(n.scrollHeight, n.offsetHeight) : n.offsetHeight) - (parseInt(e(n).css('borderTopWidth'), 10) || 0) - (parseInt(e(n).css('paddingBottom'), 10) || 0) - this.helperProportions.height - this.margins.top - this.margins.bottom
                    ];
        ...
        _convertPositionTo: function (t, n) {
            ...
            t = t == 'absolute' ? 1 : - 1;
            var r = this.cssPosition == 'absolute' && !(this.scrollParent[0] != document && e.ui.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent,
            ...
            if (this.originalPosition) {
                ...
                if (this.containment) {
                    if (this.relative_container) {
                        ...
                        u = [
                            this.containment[0] + u.left,
                            this.containment[1] + u.top,
                            this.containment[2] + u.left,
                            this.containment[3] + u.top
                        ]
    ...
    e.ui.plugin.add('draggable', 'scroll', {
        ...
        drag: function (t) {
            ...
            if (n.scrollParent[0] != document && n.scrollParent[0].tagName != 'HTML') {
                if (!r.axis || r.axis != 'x') if (n.overflowOffset.top + n.scrollParent[0].offsetHeight - t.pageY < r.scrollSensitivity) n.scrollParent[0].scrollTop = i = n.scrollParent[0].scrollTop + r.scrollSpeed;
                else if (t.pageY - n.overflowOffset.top < r.scrollSensitivity) n.scrollParent[0].scrollTop = i = n.scrollParent[0].scrollTop - r.scrollSpeed;
                if (!r.axis || r.axis != 'y') if (n.overflowOffset.left + n.scrollParent[0].offsetWidth - t.pageX < r.scrollSensitivity) n.scrollParent[0].scrollLeft = i = n.scrollParent[0].scrollLeft + r.scrollSpeed;
                else if (t.pageX - n.overflowOffset.left < r.scrollSensitivity) n.scrollParent[0].scrollLeft = i = n.scrollParent[0].scrollLeft - r.scrollSpeed
            } else {
                if (!r.axis || r.axis != 'x') if (t.pageY - e(document).scrollTop() < r.scrollSensitivity) i = e(document).scrollTop(e(document).scrollTop() - r.scrollSpeed);
                else if (e(window).height() - (t.pageY - e(document).scrollTop()) < r.scrollSensitivity) i = e(document).scrollTop(e(document).scrollTop() + r.scrollSpeed);
                if (!r.axis || r.axis != 'y') if (t.pageX - e(document).scrollLeft() < r.scrollSensitivity) i = e(document).scrollLeft(e(document).scrollLeft() - r.scrollSpeed);
                else if (e(window).width() - (t.pageX - e(document).scrollLeft()) < r.scrollSensitivity) i = e(document).scrollLeft(e(document).scrollLeft() + r.scrollSpeed)
            }
        ...
        drag: function (t, n) {
            for (var r = e(this).data('draggable'), i = r.options, s = i.snapTolerance, o = n.offset.left, u = o + r.helperProportions.width, a = n.offset.top, f = a + r.helperProportions.height, l = r.snapElements.length - 1; l >= 0; l--) {
                ...
                if (c - s < o && o < h + s && p - s < a && a < v + s || c - s < o && o < h + s && p - s < f && f < v + s || c - s < u && u < h + s && p - s < a && a < v + s || c - s < u && u < h + s && p - s < f && f < v + s) {
                    ...
                    if (!r.snapElements[l].snapping && (m || g || y || b || w)) r.options.snap.snap && r.options.snap.snap.call(r.element, t, e.extend(r._uiHash(), {
    ...
    e.widget('ui.resizable', e.ui.mouse, {
        ...
        _updateRatio: function (e) {
            var t = this.position,
                r = this.size,
                i = this.axis;
            if (n(e.height)) e.width = e.height * this.aspectRatio;
            else if (n(e.width)) e.height = e.width / this.aspectRatio;
            if (i == 'sw') {
        ...
        _respectSize: function (e) {
            ...
            if ((t = !e.width && !e.height) && !e.left && e.top) e.top = null;
            else if (t && !e.top && e.left) e.left = null;
            return e
        },
        _proportionallyResize: function () {
            if (this._proportionallyResizeElements.length) for (var t = this.helper || this.element, n = 0; n < this._proportionallyResizeElements.length; n++) {
                ...
                if (!this.borderDif) {
                    var i = [
                        r.css('borderTopWidth'),
                        r.css('borderRightWidth'),
                        r.css('borderBottomWidth'),
                        r.css('borderLeftWidth')
                    ],
                        s = [
                            r.css('paddingTop'),
                            r.css('paddingRight'),
                ...
                u = function (t, i) {
                    e(t).each(function () {
                        var t = e(this),
                            ...
                            f = i && i.length ? i : t.parents(n.originalElement[0]).length ? [
                                'width',
                                'height'
                            ] : [
                                    'width',
            ...
            if (!this.options.disabled) {
                ...
                e(t.target).parents().andSelf().each(function () {
                    ...
                    if (r) {
                        ...
                        r.unselecting = !i;
                        r.selecting = i;
                        (r.selected = i) ? n._trigger('selecting', t, {
                            selecting: r.element
                        }) : n._trigger('unselecting', t, {
                            unselecting: r.element
                        });
            ...
            if (!this.options.disabled) {
                ...
                this.selectees.each(function () {
                    ...
                    if (!(!a || a.element == n.element[0])) {
                        var l = false;
                        if (r.tolerance == 'touch') l = !(a.left > o || a.right < i || a.top > u || a.bottom < s);
                        else if (r.tolerance == 'fit') l = a.left > i && a.right < o && a.top > s && a.bottom < u;
                        if (l) {
                            if (a.selected) {
    ...
    e.widget('ui.sortable', e.ui.mouse, {
        ...
        _mouseDrag: function (t) {
            ...
            if (this.options.scroll) {
                ...
                if (this.scrollParent[0] != document && this.scrollParent[0].tagName != 'HTML') {
                    if (this.overflowOffset.top + this.scrollParent[0].offsetHeight - t.pageY < n.scrollSensitivity) this.scrollParent[0].scrollTop = r = this.scrollParent[0].scrollTop + n.scrollSpeed;
                    else if (t.pageY - this.overflowOffset.top < n.scrollSensitivity) this.scrollParent[0].scrollTop = r = this.scrollParent[0].scrollTop - n.scrollSpeed;
                    if (this.overflowOffset.left + this.scrollParent[0].offsetWidth - t.pageX < n.scrollSensitivity) this.scrollParent[0].scrollLeft = r = this.scrollParent[0].scrollLeft + n.scrollSpeed;
                    else if (t.pageX - this.overflowOffset.left < n.scrollSensitivity) this.scrollParent[0].scrollLeft = r = this.scrollParent[0].scrollLeft - n.scrollSpeed
                } else {
                    if (t.pageY - e(document).scrollTop() < n.scrollSensitivity) r = e(document).scrollTop(e(document).scrollTop() - n.scrollSpeed);
                    else if (e(window).height() - (t.pageY - e(document).scrollTop()) < n.scrollSensitivity) r = e(document).scrollTop(e(document).scrollTop() + n.scrollSpeed);
                    if (t.pageX - e(document).scrollLeft() < n.scrollSensitivity) r = e(document).scrollLeft(e(document).scrollLeft() - n.scrollSpeed);
                    else if (e(window).width() - (t.pageX - e(document).scrollLeft()) < n.scrollSensitivity) r = e(document).scrollLeft(e(document).scrollLeft() + n.scrollSpeed)
                }
            ...
            for (n = this.items.length - 1; n >= 0; n--) {
                ...
                if (s) if (i != this.currentItem[0] && this.placeholder[s == 1 ? 'next' : 'prev']()[0] != i && !e.ui.contains(this.placeholder[0], i) && (this.options.type == 'semi-dynamic' ? !e.ui.contains(this.element[0], i) : true)) {
                    ...
                    if (this.options.tolerance == 'pointer' || this._intersectsWithSides(r)) this._rearrange(t, r);
                    else break;
        ...
        _refreshItems: function (t) {
            ...
            if (i) for (var s = i.length - 1; s >= 0; s--) for (var o = e(i[s]), u = o.length - 1; u >= 0; u--) {
                ...
                if (a && a != this && !a.options.disabled) {
                    r.push([e.isFunction(a.options.items) ? a.options.items.call(a.element[0], t, {
                        item: this.currentItem
        ...
        refreshPositions: function (t) {
            ...
            else for (n = this.containers.length - 1; n >= 0; n--) {
        ...
        _createHelper: function (t) {
            ...
            t = e.isFunction(n.helper) ? e(n.helper.apply(this.element[0], [
                t,
                this.currentItem
            ])) : n.helper == 'clone' ? this.currentItem.clone() : this.currentItem;
        ...
        _setContainment: function () {
            ...
            if (!/^(document|window|parent)$/.test(t.containment)) {
                ...
                var r = e(n).css('overflow') != 'hidden';
                this.containment = [
                    t.left + (parseInt(e(n).css('borderLeftWidth'), 10) || 0) + (parseInt(e(n).css('paddingLeft'), 10) || 0) - this.margins.left,
                    t.top + (parseInt(e(n).css('borderTopWidth'), 10) || 0) + (parseInt(e(n).css('paddingTop'), 10) || 0) - this.margins.top,
                    t.left + (r ? Math.max(n.scrollWidth, n.offsetWidth) : n.offsetWidth) - (parseInt(e(n).css('borderLeftWidth'), 10) || 0) - (parseInt(e(n).css('paddingRight'), 10) || 0) - this.helperProportions.width - this.margins.left,
                    t.top + (r ? Math.max(n.scrollHeight, n.offsetHeight) : n.offsetHeight) - (parseInt(e(n).css('borderTopWidth'), 10) || 0) - (parseInt(e(n).css('paddingBottom'), 10) || 0) - this.helperProportions.height - this.margins.top
                ]
            }
        },
        _convertPositionTo: function (t, n) {
    ...
    e.widget('ui.button', {
        ...
        _create: function () {
            ...
            var u = this,
                ...
                c = 'ui-state-hover' + (!f ? ' ui-state-active' : '');
        ...
        _setOption: function (t, n) {
            e.Widget.prototype._setOption.apply(this, arguments);
            if (t === 'disabled') n ? this.element.propAttr('disabled', true) : this.element.propAttr('disabled', false);
    ...
    e.widget('ui.dialog', {
        ...
        _makeDraggable: function () {
            ...
            n.uiDialog.draggable({
                ...
                stop: function (o, u) {
                    r.position = [
                        u.position.left - i.scrollLeft(),
                        u.position.top - i.scrollTop()
                    ];
        ...
        destroy: function (t) {
            ...
            this.instances.length === 0 && e([document,
                window]).unbind('.dialog-overlay');
            t.remove();
            var r = 0;
        ...
        _create: function () {
            ...
            if (n.range) {
                if (n.range === true) {
                    ...
                    if (n.values.length && n.values.length !== 2) n.values = [
                        n.values[0],
                        n.values[0]
                    ]
                }
        ...
        _refreshValue: function () {
            ...
            if (this.options.values && this.options.values.length) this.handles.each(function (t) {
                ...
                if (r.options.range === true) if (r.orientation === 'horizontal') {
                    if (t === 0) r.range.stop(1, 1)[i ? 'animate' : 'css']({
                        left: s + '%'
                    }, n.animate);
                    if (t === 1) r.range[i ? 'animate' : 'css']({
                        width: s - u + '%'
                    }, {
                            queue: false,
                            duration: n.animate
                ...
                if (t === 'min' && this.orientation === 'horizontal') this.range.stop(1, 1)[i ? 'animate' : 'css']({
                    width: s + '%'
                }, n.animate);
                if (t === 'max' && this.orientation === 'horizontal') this.range[i ? 'animate' : 'css']({
                    width: 100 - s + '%'
                }, {
                        queue: false,
                        duration: n.animate
                    });
                if (t === 'min' && this.orientation === 'vertical') this.range.stop(1, 1)[i ? 'animate' : 'css']({
                    height: s + '%'
                }, n.animate);
                if (t === 'max' && this.orientation === 'vertical') this.range[i ? 'animate' : 'css']({
                    height: 100 - s + '%'
                }, {
                        queue: false,
                        duration: n.animate
    ...
    e.widget('ui.tabs', {
        ...
        _setOption: function (e, t) {
            if (e == 'selected') this.options.collapsible && t == this.options.selected || this.select(t);
            else {
                this.options[e] = t;
                this._tabify()
            }
        ...
        _cookie: function () {
            ...
            return e.cookie.apply(null, [
                t
            ].concat(e.makeArray(arguments)))
        },
        _ui: function (e, t) {
            return {
                tab: e,
        ...
        load: function (t) {
            ...
            this.abort();
            if (!s || this.element.queue('tabs').length !== 0 && e.data(i, 'cache.tabs')) this.element.dequeue('tabs');
            else {
    ...
    d.extend(M.prototype, {
        ...
        _optionDatepicker: function (e, t, n) {
            ...
            if (arguments.length == 2 && typeof t == 'string') return t == 'defaults' ? d.extend({
            }, d.datepicker._defaults) : r ? t == 'all' ? d.extend({
        ...
        _doKeyDown: function (e) {
            ...
            if (d.datepicker._datepickerShowing) switch (e.keyCode) {
                ...
                default:
                    n = false
            } else if (e.keyCode == 36 && e.ctrlKey) d.datepicker._showDatepicker(this);
            else n = false;
            if (n) {
                e.preventDefault();
                e.stopPropagation()
        ...
        _triggerOnClose: function (e) {
            ...
            if (t) t.apply(e.input ? e.input[0] : null, [
                e.input ? e.input.val() : '',
                e
            ])
        },
        ...
        _selectDate: function (e, t) {
            ...
            if (n) n.apply(e.input ? e.input[0] : null, [
                t,
                e
            ]);
            else e.input && e.input.trigger('change');
            if (e.inline) this._updateDatepicker(e);
            else {
        ...
        iso8601Week: function (e) {
            ...
            e.setMonth(0);
            e.setDate(1);
            return Math.floor(Math.round((t - e) / 86400000) / 7) + 1
        },
        parseDate: function (e, t, n) {
            ...
            for (var i = (n ? n.dayNamesShort : null) || this._defaults.dayNamesShort, s = (n ? n.dayNames : null) || this._defaults.dayNames, o = (n ? n.monthNamesShort : null) || this._defaults.monthNamesShort, u = (n ? n.monthNames : null) || this._defaults.monthNames, a = n = - 1, f = - 1, l = - 1, c = false, h = function (t) {
                ...
                g++
            }, g = 0, y = 0; y < e.length; y++) if (c) if (e.charAt(y) == '\'' && !h('\'')) c = false;
            else m();
                    ...
                    case '@':
                        ...
                        break;
                    case '!':
                        b = new Date((p('!') - this._ticksTo1970) / 10000);
                        n = b.getFullYear();
                        a = b.getMonth() + 1;
                        f = b.getDate();
                        break;
            ...
            else if (n < 100) n += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (n <= r ? 0 : - 100);
            if (l > - 1) {
                a = 1;
                f = l;
                do {
        ...
        formatDate: function (e, t, n) {
            ...
            var o = function (t) {
                ...
                f = '',
                l = false;
            if (t) for (var c = 0; c < e.length; c++) if (l) if (e.charAt(c) == '\'' && !o('\'')) l = false;
            else f += e.charAt(c);
                ...
                case 'D':
                    ...
                    break;
                case 'o':
                    f += u('o', Math.round(((new Date(t.getFullYear(), t.getMonth(), t.getDate())).getTime() - (new Date(t.getFullYear(), 0, 0)).getTime()) / 86400000), 3);
                    break;
                case 'm':
                ...
                case '@':
                    ...
                    break;
                case '!':
                    f += t.getTime() * 10000 + this._ticksTo1970;
                    break;
                case '\'':
                    if (o('\'')) f += '\'';
                    else l = true;
        ...
        _possibleChars: function (e) {
            for (var t = '', n = false, r = function (t) {
                ...
                return t
            }, i = 0; i < e.length; i++) if (n) if (e.charAt(i) == '\'' && !r('\'')) n = false;
            else t += e.charAt(i);
        ...
        _generateHTML: function (e) {
            ...
            var n = this._get(e, 'isRTL'),
                ...
                f = o[0] != 1 || o[1] != 1,
                l = this._daylightSavingAdjust(!e.currentDay ? new Date(9999, 9, 9) : new Date(e.currentYear, e.currentMonth, e.currentDay)),
            ...
            for (var x = this._getDefaultDate(e), T = '', N = 0; N < o[0]; N++) {
                ...
                for (var k = 0; k < o[1]; k++) {
                    ...
                    for (var D = 0; D < M; D++) {
                        ...
                        for (A = 0; A < 7; A++) {
                            var H = w ? w.apply(e.input ? e.input[0] : null, [
                                _
                            ]) : [
                                    true,
                                    ''
    ...
    d.fn.datepicker = function (e) {
        ...
        if (typeof e == 'string' && (e == 'isDisabled' || e == 'getDate' || e == 'widget')) return d.datepicker['_' + e + 'Datepicker'].apply(d.datepicker, [
            this[0]
        ].concat(t));
        if (e == 'option' && arguments.length == 2 && typeof arguments[1] == 'string') return d.datepicker['_' + e + 'Datepicker'].apply(d.datepicker, [
            this[0]
        ].concat(t));
        return this.each(function () {
            typeof e == 'string' ? d.datepicker['_' + e + 'Datepicker'].apply(d.datepicker, [
                this
            ].concat(t)) : d.datepicker._attachDatepicker(this, e)
        })
    };
    d.datepicker = new M;
...
jQuery.effects || function (e, t) {
    function n(t) {
        ...
        if (n = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(t)) return [parseInt(n[1], 10),
        parseInt(n[2], 10),
        parseInt(n[3], 10)];
        if (n = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(t)) return [parseFloat(n[1]) * 2.55,
        parseFloat(n[2]) * 2.55,
        parseFloat(n[3]) * 2.55];
        if (n = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(t)) return [parseInt(n[1], 16),
        parseInt(n[2], 16),
        parseInt(n[3], 16)];
        if (n = /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(t)) return [parseInt(n[1] + n[1], 16),
        parseInt(n[2] + n[2], 16),
        parseInt(n[3] + n[3], 16)];
    ...
    e.fn.extend({
        ...
        toggleClass: function (n, r, i, s, o) {
            return typeof r == 'boolean' || r === t ? i ? e.effects.animateClass.apply(this, [
                r ? {
                    add: n
                }
                    : {
    ...
    e.extend(e.easing, {
        ...
        easeInOutElastic: function (e, t, n, r, i) {
            ...
            if (t < 1) return - 0.5 * o * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * i - e) * 2 * Math.PI / s) + n;
            return o * Math.pow(2, - 10 * (t -= 1)) * Math.sin((t * i - e) * 2 * Math.PI / s) * 0.5 + r + n
        },
    ...
    e.effects.bounce = function (t) {
        return this.queue(function () {
            ...
            o = t.options.distance || (f == 'top' ? n.outerHeight({
                margin: true
            }) / 3 : n.outerWidth({
                margin: true
            }) / 3);
    ...
    e.effects.size = function (t) {
        return this.queue(function () {
            ...
            if (h == 'content' || h == 'both') {
                u = u.concat(['marginTop',
                    'marginBottom']).concat(o);
                a = a.concat(['marginLeft',
                    'marginRight']);
    ...
    13: 584,
    36: 0
}; var lastPage = ''; var lastTime = new Date(- 300); var lastMessageBoxLayer = 10000; MessageBox.prototype = {
    timer: null,
    msgbox: null,
    bindobj: null,
    incomingTimer: null,
...
}; var evCardTimer = null; var searchKW = ''; var tmrCardError = null; var card_obj = null; var last_sug_user_start = 0; var mouIntervals = null; var timi = 0; $(document).ready(function () {
    $num = $('.num li');
...
}); var cb_controler; var scrollActivate = true; if (!Array.prototype.shuffle) {
...
$(function () {
    ...
    return window.bindSlt = t.bind = function (e, i) {
        ...
        t.create = function (t) {
            ...
            $('<span>').addClass('txt').appendTo(e),
                $('<div>').addClass('b-slt-arrow').appendTo(e);
            var i = $('<ul>').addClass('list').appendTo(e);
            t.wrapper && e.wrap(t.wrapper);
            for (var s = t.items || [
            ], o = 0; o < s.length; o++) {
                var n = s[o],
                    a = $('<li></li>').text(n.name).appendTo(i);
                if (n.selected && a.attr('selected', 'selected'), n.attributes) for (var l in n.attributes) a.attr(l, n.attributes[l])
            }
            return t.wrapper && (e = e.parent()),
                e
        },
        t.prototype.init = function () {
            var t = this.obj,
                e = this,
                i = this.list.find('[selected]');
            0 == i.length && (i = this.list.find('li').eq(0).attr('selected', 'selected')),
                t.find('.txt').html(i.html()),
                t.off('mouseenter.selectMenu'),
                t.off('mouseleave.selectMenu'),
                t.off('click.selectMenu'),
                t.on('click.selectMenu', function (t) {
                    e._tap(t)
                }),
        ...
        t.prototype._mover = function (t) {
            ...
            if (!this.obj.attr('disabled') && this.list.length) {
                ...
                this.obj.addClass('on'),
                    ...
                    !1 === this.params.hover && ($(document).off('click.selectMenu'), $(document).one('click.selectMenu', function (t) {
                        s._mout(t)
                    }))
            }
        },
        t.prototype._mout = function () {
            this.obj.removeClass('on'),
                this.list.hide(),
                this._active = !1,
                !1 === this.params.hover && $(document).off('click.selectMenu')
        },
        ...
        t.prototype.select = function (t, e) {
            this._mout(t),
                (!e || this._change(e)) && ('undefined' == typeof e && (e = this.value()), this.change(e, t))
        },
        t.prototype.change = function (t, e) {
            t = t || this.value(),
                'function' == typeof this.params.onChange && this.params.onChange.call(this, t, e)
        },
        ...
        t.prototype.value = function (t, e) {
            if (e) {
                ...
                return i.length && this._change(i),
                    i
            }
        ...
        t.prototype.createMenu = function (t) {
            $('<span>').addClass('txt').appendTo(t),
                $('<div>').addClass('b-slt-arrow').appendTo(t);
            var e = this.params;
        ...
        t.prototype.setPos = function (t) {
            t.css(t.offset().left + t.width() - 10 > $('.z').width() ? {
                left: 'auto',
                right: '-1px'
            }
                : {
        ...
        t.prototype.reset = function () {
            ...
            $('li', this.list).removeAttr('selected'),
                ...
                $('.txt', this.obj).html(t.html()),
                t.attr('disabled') || this.change(t)
        },
