...
const ChatFilterSubPageBody = ({chatFilter, handleSetOption}) => {
    return (
        <List>
            <ListItem
                onClick={() => handleSetOption('chatFilter')}
                operation={<Radio on={chatFilter.on}/>}
                subList={{
                    children: <CheckBoxGroup
                        data={chatFilter.types}
                        value={chatFilter.value}
                        onClick={(value) => handleSetOption('chatFilter', value)}
                    />,
                }}
            >打开屏蔽功能</ListItem>
        </List>
    ...
    render() {
        ...
        return <React.Fragment>
            ...
            <OptionBody>
                    ...
                    >
                        {subPageTitle === '高级屏蔽设置' && <ChatFilterSubPageBody chatFilter={chatFilter} handleSetOption={this.handleSetOption}/>}
                    </SubPage>
                    <List title="主站" ref={i => this.mainList = i}>
                        <ListItem
                            operation={
                                <Button icon onClick={() => this.handleSetSubPage({parent: this.mainList})}><Icon
                    ...
                    <List title="直播" ref={i => this.liveList = i}>
                        ...
                        <ListItem
                            onClick={() => this.handleSetSubPage({
                                title: '高级屏蔽设置',
                                parent: this.liveList,
                                // body: ,
                            })}
                            operation={<Button icon><Icon type="arrowRight"/></Button>}
                        >聊天信息屏蔽设置</ListItem>
                    </List>
                    <List
                        title="其他"
